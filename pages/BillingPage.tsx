...
const BillingPage: React.FC<BillingPageProps> = ({ lang, customers, vehicles, templates }) => {
              ...
              <div className="p-10 space-y-10">
                ...
                <div className="flex justify-between items-start">
                   <div className="flex items-center gap-6">
                      <img src={client?.profilePicture} className="w-16 h-16 rounded-full border-4 border-white shadow-xl object-cover" />
                      <div>
                ...
                <div className="flex items-center gap-6 p-6 bg-white border border-gray-50 rounded-[2.5rem] shadow-sm">
                   <img src={vehicle?.mainImage} className="w-20 h-14 object-cover rounded-xl shadow-lg border-2 border-white" />
                   <div>
                           ...
                           <div className="w-full border-t-2 border-gray-900 mt-4 overflow-hidden">
                              <table className="w-full text-[9px] font-black uppercase">
                                 ...
                                 <tbody className="opacity-40">
                                   {/* Fixed: Wrapped variable placeholders in strings and passed to replaceVariables to avoid invalid JSX shorthand property error */}
